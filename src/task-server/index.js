      ...
      ws.on('message', message => {
        ...
        switch (type) {
          ...
          case 'getTask':
            ...
            break
          case 'importTasks':
            importTasks(msg, ws, server, logger)
            break
          case 'newTask':
          ...
          case 'renameTask':
            ...
            break
          case 'newBenchmarkTask':
            newBenchmarkTask(msg, ws, server, logger)
            break
          case 'archiveTask':
          ...
          case 'observeTask':
            ...
            break
          case 'updateClientDescr':
            updateClientDescr(msg, ws, server, logger)
            break
          default:
